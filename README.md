...
> Infrastructure deployed to Azure using `terraform apply`

### Resource Group — All Resources
![Resource Group](screenshots/01-resource-group.png)

### AKS Cluster — Running
![AKS Cluster](screenshots/02-aks-cluster.png)

### Key Vault — Secrets Management
![Key Vault](screenshots/03-key-vault.png)

### Azure Container Registry
![ACR](screenshots/04-acr.png)

### Virtual Network — Subnets
![VNet Subnets](screenshots/05-vnet-subnets.png)
